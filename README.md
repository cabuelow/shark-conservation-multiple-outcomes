...
This repository contains code to estimate the effect of management on reef shark abundance globally and predict outcomes under counterfactual scenarios.
